...
def fake_user_description
  descriptions = [
    ...
    ["J'aime pas Noël ; je déteste les enfants et la joie de vivre me donne envie de vomir !", "Grumpygrampa", "https://i.imgur.com/g5DBPWB.png"],
    ...
    ["J'ai peur des gens ='O, alors pour me soigner, je vais m'immerger au milieu des autochtones du pays parisien, loin de ma patrie de Versailles... Je suis sur la bonne voie.", "Jacquouille", "app/assets/images/fripouille.jpg"],
  ]
end
